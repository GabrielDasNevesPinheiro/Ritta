...
export default abstract class Dice extends Command {
  ...
  static async execute(interaction: CommandInteraction<CacheType>) {
    ...
    let diceEmbed = new EmbedBuilder()
      ...
      .setDescription(` ${botConfig.GG} | ${mention}, Você está prestes a apostar ${botConfig.getCashString(ammount)} no Dice! Selecione seu número da sorte para continuar.\n` +
